...
public:
	...
	// Initialize and configure the materials for all objects prior to the rendering process
	void DefineObjectMaterials();
	// Set up and configure the various light sources in the scene before rendering begins
	void SetupSceneLights();

	// Render individual objects in the 3D scene
	void RenderFloor();
	void RenderBackWall();
	...
	void RenderCandle();
	void RenderLeftChair();
	void RenderRightChair();
	void RenderLeftWineGlass();
	void RenderRightWineGlass();
	void RenderLeftPlate();
	void RenderRightPlate();
	void RenderLeftFork();
	void RenderRightFork();
};